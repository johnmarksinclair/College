...
int main() {
	...
	check((char*)"poly(2)", poly(2), 7);
	check((char*)"poly(3)", poly(3), 13);
	check((char*)"poly(-1)", poly(-1), 1);
	check((char*)"poly(-2)", poly(-2), 3);

	// Factorial evaluation
	check((char*)"factorial(5)", factorial(5), 120);
	check((char*)"factorial(4)", factorial(4), 24);
	check((char*)"factorial(10)", factorial(7), 5040);
	check((char*)"factorial(6)", factorial(6), 720);
