...
//~ Validation methods ..........................................................
	 ...
	 *         otherwise.
	 *         
	 *         Worst-case running time: O(N), this is due to the use of one for loop
	 **/
	 ...
	 *         otherwise.
	 *         
	 *         Worst-case running time: O(N), again this is due to the use of one for loop
	 **/
...
//~ Evaluation  methods ..........................................................
	 ...
	 *         
	 *         Worst-case running time: O(N), this is due to the three separate for loops this method invokes
	 **/
	 ...
	 * @return the integer result of evaluating the expression
	 *         
	 *         Worst-case running time: O(N), this is due to the two separate for loops this method calls
	 **/
...
//~ Conversion  methods ..........................................................
	 ...
	 *         
	 *         Worst-case running time: O(N), this due to the three separate for loops used in the method
	 **/
	 ...
	 *         
	 *         Worst-case running time: O(N), again this due to the three separate for loops used in the method
	 **/
	 ...
	 *         
	 *         Worst-case running time: O(N), this method calls five separate for loops
	 **/
	 ...
	 * @return the expression in infix order.
	 *         
	 *         Worst-case running time: O(N), this method uses three separate for loops
	 **/
 ...
 * - Stack:
 * 		Methods Called:
 * 		- evaluatePrefixOrder: O(N)
 * 		- evaluatePostfixOrder: O(N)
 * 		- convertPrefixToPostfix: O(N)
 * 		- convertPostfixToPrefix: O(N)
 * 		- convertPrefixToInfix: O(N)
 * 		- convertPostfixToInfix: O(N)
 * - String Array
 * 		Methods Called:
 * 		- validatePrefixOrder: O(N)
 * 		- validatePostfixOrder: O(N)
 * 		- evaluatePrefixOrder: O(N)
 * 		- evaluatePostfixOrder: O(N)
 * 		- convertPrefixToPostfix: O(N)
 * 		- convertPostfixToPrefix: O(N)
 ...
 * 		- convertPostfixToInfix: O(N)
 * 
 * I believe these were the optimal methods of performing these tasks
 **/